...
const Image = styled(Box)`
     background: #2874f0 url(https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/login_img_c4a81e.png) center 82% no-repeat;
     height: 82.8%;
     width: 28%;
     padding: 44px 35px;
     & > p, & > h5{
          ...
          <Box style={{display: 'flex', height: '100%'}}>
            ...
            { 
              ...
              :
                    ...
                    <TextField variant='standard' onChange={(e) => onInputChange(e)} name='phone' label='Enter Your Phone Number' />
